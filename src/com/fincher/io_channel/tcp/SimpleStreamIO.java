...
/** Uses a simple scheme of prepending a 4 byte integer containing the length of the message before sending 
 * 
...
public class SimpleStreamIO implements StreamIOIfc {
	...
	/** Creates a 4 byte integer containing the length of the given bytes.
	 * This 4 bytes along with the given bytes are concatenated and returned
	 * @param bytes
