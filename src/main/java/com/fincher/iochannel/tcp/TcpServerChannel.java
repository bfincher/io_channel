...
/**
 * A TCPIOChannel implementation for TCP Server sockets.
 * 
...
public class TcpServerChannel extends TcpChannel {
    ...
    @Override
    protected CallableTask<Socket> getConnectTask() throws ChannelException {
        return TcpServerConnectTask.create(this);
    }
