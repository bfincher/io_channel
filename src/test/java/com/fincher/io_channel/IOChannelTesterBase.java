...
//	/** Load configuration from the config file into a map of configurations.
//	 * The source config file's contents will be copied to the destConfigFile's contents
//	 * @param sourceConfigFile
//	 * @param destConfigFile
//	 * @param schemaFile
//	 * @throws Exception
//	 */
//	public void loadConfigMap(File sourceConfigFile,
//			File destConfigFile,
...
//		try {
//			config = JAXBLoader.load(destConfigFile, schemaFile, IoChannels.class, Logger.getLogger(IOChannelTester.class));			
//		}
//		catch (Exception e) {
//			e.printStackTrace();
//			fail();
...
//	}
	 ...
	 */
	protected void test(IOChannelIfc<T> input, 
			IOChannelIfc<T> output, 
